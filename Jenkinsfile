pipeline {
  ...
  environment {
    ...
    IG_USER = 'imagegenius'
    IG_REPO = 'docker-maintenance'
    CONTAINER_NAME = 'maintenance'
    DOCKERHUB_IMAGE = 'imagegenius/maintenance'
    DEV_DOCKERHUB_IMAGE = 'igdev/maintenance'
    PR_DOCKERHUB_IMAGE = 'igpipepr/maintenance'
    DIST_IMAGE = 'alpine'
    DIST_TAG = '3.17'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/imagegenius/docker-maintenance/packages\" \
          --label \"org.opencontainers.image.source=https://github.com/imagegenius/docker-maintenance\" \
          ...
          --label \"org.opencontainers.image.description=[Maintenance](https://imagegenius/docker-maintenance/) - Minimal Nginx Docker image with a soul purpose to be a maintenance page for when your main webserver is down\" \
